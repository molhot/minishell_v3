...
SRCS	=	tokenizer/tokenizer.c tokenizer/create_token.c\
			...
			exec_func/exec_func.c exec_func/exec_builtin.c exec_func/pipe_func.c exec_func/redirect_file.c expand/expand_swaitch_doller.c expand/export_argsremake.c\
